...
describe 'carbon::relay' do
  let (:thing) { "/var/lib/puppet/concat/_opt_graphite_conf_carbon.conf/fragments/20_relay" }
  ...
  it { should contain_file('/etc/init/carbon-relay.conf') }
  it { should contain_service('carbon-relay') }
end
